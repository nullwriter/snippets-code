    ...
    <div class="modal-dialog" style="width: 72rem;">
        <div class="modal-content">
            <div class="modal-header" style="text-align: left;background-color: #e0e0e0;">
                ...
                <h4 class="modal-title" id="myModalLabel">@lang('pcustomer::text.general.customers') ({!! $id !!})</h4>
            </div>
            <div class="modal-body">

                <form class="form-inline row">
                    <div class="form-group" style="float: right;margin-right: 1.5rem;">
                        <input onclick="AutoComplete.search('internal_id','customers')" placeholder="Customer ID" style="width: 30rem;" id="search-cust-product" class="form-control col-sm-12" type="text" value=""  />
                        <a class="btn btn-flat btn-default search-prod-btn" id="search-prod">
